...
func init() {
	...
	kubeVipCmd.PersistentFlags().BoolVar(&initConfig.EnableNodeLabeling, "enableNodeLabeling", false, "Enable leader node labeling with \"kube-vip.io/is-leader=true/false\", defaults to false")
	kubeVipCmd.PersistentFlags().StringVar(&initConfig.NodeLabelName, "nodeLabelName", "kube-vip.io/is-leader", "Configure node label name (defaults to \"kube-vip.io/is-leader\"")
